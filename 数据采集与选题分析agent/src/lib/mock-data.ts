...
const claudecodeTopics = {
  workflow: topicIdea(
    "cc-topic-0326-workflow",
    "Claude Code 三平台工作流拆解",
    "围绕 Claude Code 的提示词工程、任务拆解和复盘模板，整理成小红书、B 站、抖音三种内容形态。",
    "小红书图文、B 站长视频和抖音短口播同时出现同一套操作逻辑，说明用户对可复制工作流的需求在同步抬头。",
    "同一套 Claude Code 方法，为什么在三个平台能拆成三种爆款表达？",
...
const vibecodingTopics = {
  demoWorkflow: topicIdea(
  ...
  indieBuild: topicIdea(
    ...
    [
      evidence(
        ...
        ["xiaohongshu", "weibo"],
        "小红书侧重过程整理，微博侧重话题讨论，形成双平台互补。"
      )
    ]
  ),
  tasteTools: topicIdea(
...
export const monitorCategories: MonitorCategory[] = [
  {
    ...
    reports: [
      dailyReport(
        ...
        4,
        2,
        [claudecodeTopics.workflow, claudecodeTopics.toolchain]
      ),
      dailyReport(
        "2026-03-25",
        ...
        3,
        1,
        [claudecodeTopics.promptLibrary]
      )
    ],
    content: [
      contentItem(
        ...
        "这条内容把需求拆解、模板复用和工作流结构讲得很清楚，收藏意图非常强。",
        ["cc-topic-0326-workflow"],
        true,
        true
      ),
      contentItem(
        ...
        "2.1k",
        ["工作流复盘", "提示词链路", "产品页复刻"],
        "视频重点展示从需求到产物的完整过程，适合承接想看实操的开发者。",
        ["cc-topic-0326-workflow"],
        true,
        true
      ),
  ...
  },
  {
    ...
    todayCollectionCount: 15,
    reportStatus: "已完成",
    overview: {
      platformCount: 4,
      keywordCount: 7,
      creatorCount: 4,
      updatedAt: "2026-03-26 20:05"
    },
    actionItems: [
      actionItem(
        "vc-action-1",
    ...
    reports: [
      dailyReport(
        ...
        4,
        2,
        [vibecodingTopics.demoWorkflow, vibecodingTopics.indieBuild]
      ),
      dailyReport(
        "2026-03-24",
